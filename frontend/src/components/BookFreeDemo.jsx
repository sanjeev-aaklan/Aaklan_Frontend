...
//       if (data.success) {
//         setIsOtpSent(true);
//         setSubmitStatus('OTP sent successfully');
...
//       if (data.success) {
//         setIsOtpVerified(true);
//         setSubmitStatus('Phone number verified successfully!');
//         toast.success('Phone number verified successfully!')
//         setErrors({});
//       } else {
//         setErrors({ otp: data.message || 'Invalid OTP' });
...
//       if (data.success) {
//         setSubmitStatus('Demo request submitted successfully!');
...
//             {/* Status Message */}
//             {submitStatus && (
//               <div className={`mb-6 p-3 rounded-xl backdrop-blur-sm border transition-all duration-300 ${
//                 submitStatus.includes('successfully') 
//                   ? 'bg-gradient-to-r from-green-500/20 to-emerald-500/20 border-green-500/20 text-green-400' 
//                   : 'bg-gradient-to-r from-red-500/10 to-rose-500/10 border-red-500/20 text-red-400'
//               }`}>
//                 <div className="flex items-center justify-between">
//                   <div className="flex items-center gap-2">
...
//                       </svg>
//                     )}
//                     <span className="text-sm">{submitStatus}</span>
//                   </div>
//                   <button
//                     type="button"
//                     onClick={() => setSubmitStatus('')}
...
//                     onChange={handleChange}
//                     required
//                     className={`relative w-full px-4 py-3 bg-gray-900/50 border rounded-lg focus:ring-2 focus:ring-cyan-500/50 focus:border-transparent transition-all duration-200 outline-none text-white placeholder-gray-500 text-sm ${
//                       errors.name ? 'border-red-500/50' : 'border-white/10'
//                     }`}
//                     placeholder="John Doe"
//                   />
//                 </div>
//                 {errors.name && (
//                   <p className="text-red-400 text-xs flex items-center gap-1 mt-0.5 ml-1">
//                     <svg className="w-3 h-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
//                       <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
//                     </svg>
//                     {errors.name}
...
//                 {/* OTP Verification Section */}
//                 {isOtpSent && !isOtpVerified && (
//                   <div className="mt-4 p-4 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 rounded-xl border border-cyan-500/20 backdrop-blur-sm">
//                     <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-3">
//                       <div className="space-y-0.5">
//                         <label className="block text-sm font-medium text-gray-300">
//                           Enter 6-digit OTP sent to your email
...
//                           maxLength="6"
//                           placeholder="• • • • • •"
//                           className={`relative w-full px-4 py-3 bg-gray-900/50 border rounded-lg focus:ring-2 focus:ring-green-500/50 focus:border-transparent transition-all duration-200 outline-none text-center text-xl font-mono tracking-widest text-white ${
//                             errors.otp ? 'border-red-500/50' : 'border-white/10'
//                           }`}
//                         />
//                       </div>
...
//                     onChange={handleChange}
//                     required
//                     className={`relative w-full px-4 py-3 bg-gray-900/50 border rounded-lg focus:ring-2 focus:ring-cyan-500/50 focus:border-transparent transition-all duration-200 outline-none text-white appearance-none text-sm ${
//                       errors.scheduleCallFor ? 'border-red-500/50' : 'border-white/10'
//                     }`}
//                   >
//                     <option value="" className="bg-gray-900">Select Option</option>
...
//                     onChange={handleChange}
//                     rows="3"
//                     className="relative w-full px-4 py-3 bg-gray-900/50 border border-white/10 rounded-lg focus:ring-2 focus:ring-cyan-500/50 focus:border-transparent transition-all duration-200 outline-none text-white placeholder-gray-500 text-sm resize-none"
//                     placeholder="Tell us about your specific requirements, preferred demo time, or any questions you have..."
//                   />
//                 </div>
//               </div>
...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-[#0b234a] via-[#1a3b6c] to-[#2a5298] p-3 sm:p-4 lg:p-6 relative overflow-hidden">
//       {/* Animated Background Elements */}
//       <div className="absolute inset-0 overflow-hidden">
//         <div className="absolute top-0 -left-20 w-72 h-72 bg-gradient-to-r from-[#E22213]/10 to-orange-500/10 rounded-full blur-3xl animate-pulse"></div>
//         <div className="absolute bottom-0 -right-20 w-72 h-72 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
...
//             Experience future-ready education. Schedule a personalized demo.
//           </p>
//         </div>

//         {/* Form Container */}
//         <div className="backdrop-blur-xl bg-white/5 rounded-2xl sm:rounded-3xl border border-white/10 shadow-xl">
//           <form onSubmit={handleSubmit} className="p-4 sm:p-6 md:p-8">
...
//                   value={formData.name}
//                   onChange={handleChange}
//                   className={`w-full px-3 sm:px-4 py-2.5 bg-[#0B234A] border rounded-lg focus:ring-2 focus:ring-cyan-500/50 focus:border-transparent outline-none text-white text-sm ${
//                     errors.name ? 'border-red-500/50' : 'border-white/10'
//                   }`}
//                   placeholder="John Doe"
//                 />
...
//                   Phone Number *
//                   {isOtpVerified && (
//                     <span className="inline-flex items-center gap-1 px-2 py-0.5 ml-2 text-xs bg-green-500/20 text-green-400 rounded-full">
//                       ✓ Verified
//                     </span>
//                   )}
//                 </label>
...
//                       <div>
//                         <p className="text-sm text-gray-300">Enter 6-digit OTP</p>
//                         <p className="text-xs text-gray-400">Sent to {formData.email}</p>
//                       </div>
//                       <button
//                         type="button"
//                         onClick={handleResetOtp}
...
//                           maxLength="6"
//                           placeholder="••••••"
//                           className={`w-full px-4 py-3 bg-[#0B234A] border rounded-lg focus:ring-2 focus:ring-green-500/50 focus:border-transparent outline-none text-center text-xl font-mono tracking-widest text-white ${
//                             errors.otp ? 'border-red-500/50' : 'border-white/10'
//                           }`}
//                         />
//                       </div>
...
//                 />
//                 {errors.schoolAddress && (
//                   <p className="text-red-400 text-xs mt-1">{errors.schoolAddress}</p>
//                 )}
//               </div>
...
//                   value={formData.scheduleCallFor}
//                   onChange={handleChange}
//                   className={`w-full px-3 sm:px-4 py-2.5 border bg-[#0B234A] rounded-lg focus:ring-2 focus:ring-cyan-500/50 focus:border-transparent outline-none text-white text-sm appearance-none ${
//                     errors.scheduleCallFor ? 'border-red-500/50' : 'border-white/10'
//                   }`}
//                 >
//                   <option value="">Select Option</option>
//                   <option value="AI and Robotics Lab">AI and Robotics Lab</option>
//                   <option value="Computer & Coding Books">Computer & Coding Books</option>
//                   <option value="Dedicated Trainer">Dedicated Trainer</option>
//                   <option value="VR/AR Lab">VR/AR Lab</option>
//                   <option value="Workshop in School">Workshop in School</option>
//                   <option value="Other">Other</option>
//                 </select>
//                 {errors.scheduleCallFor && (
//                   <p className="text-red-400 text-xs mt-1">{errors.scheduleCallFor}</p>
//                 )}
//               </div>
...
//                   onChange={handleChange}
//                   rows="3"
//                   className="w-full px-3 sm:px-4 py-2.5 bg-[#0B234A] border border-white/10 rounded-lg focus:ring-2 focus:ring-cyan-500/50 focus:border-transparent outline-none text-white text-sm resize-none"
...
//                 className={`w-full py-3 px-6 rounded-lg font-semibold text-white text-sm transition-colors ${
