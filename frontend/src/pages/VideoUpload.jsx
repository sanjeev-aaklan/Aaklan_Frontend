...
const VideoUpload = () => {
  ...
  const uploadVideoToCloudinary = async (file, onProgress) => {
    ...
    formData.append("folder", "career_videos");
  ...
  const checkVideoStatus = async (email) => {
    try {
      setCheckingStatus(true);

      const res = await axios.get(
        `${import.meta.env.VITE_BACKEND_URL}/api/career/upload-video-status?email=${email}`,
      );
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Upload your response video for the interview process
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {status !== "topic_sent" && !checkingStatus && (
              <p className="text-red-500 text-sm text-center">
                Video upload not allowed yet.
              </p>
            )}
  ...
  status === "topic_sent"
    ...
    : "bg-gray-400 cursor-not-allowed"
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-gray-500">
              Need help? Ensure your video is clear and addresses the topic
              properly.
            </p>
          </div>
        </div>
